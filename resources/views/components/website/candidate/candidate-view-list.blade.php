                    ...
                    <div class="rt-single-icon-box tw-flex-wrap tw-gap-3">
                        <div class="icon-thumb">
                            <div class="profile-image position-relative">
                                <img src="{{ asset('assets/images/default.png') }}" alt="{{ __('candidate_image') }}" class="object-fit-contain">
                        ...
                        <div class="iconbox-content !tw-m-0">
                            <div class="post-info2">
                                <div class="post-main-title">
                                        ...
                                        <a href="javascript:void(0)" onclick="showCandidateProfileModal('{{ $candidate->full_name }}')">
                                            {{ $candidate->full_name }}
                                        </a>
                        ...
                        <div class="iconbox-extra align-self-center">
                            <div>
                                        ...
                                        <a onclick="showCandidateProfileModal('{{ $candidate->id }}')"
