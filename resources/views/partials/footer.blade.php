            ...
            <div class="row">
                <div class="col-lg-4 col-md-5 col-sm-6 rt-single-widget ">
                    <a href="#" class="footer-logo">
                        <img src="https://dev-jobshine.s3.ap-southeast-1.amazonaws.com/public/img/home-logo.png" alt="logo" loading="lazy">
                    </a>
                    <address>
                        <div class="body-font-2 text-gray-500">
                                ...
                                <div class="body-font-2 text-gray-500">
                                    ...
                                    <a href="tel:+254729790289" class="text-gray-10">
                                        +254729790289</a>
                                </div>

                            <div class="max-312 body-font-4 mt-2 text-gray-500">
                                {{ __('Powered by mitchsofts.com') }}
                            </div>
                        </div>
                    </address>
                </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-6 rt-single-widget ">
                    ...
                    <ul class="rt-usefulllinks2">
                        <li><a href="#">{{ __('post a job') }}</a></li>

                            <li><a href="#">{{ __('Browse employers') }}</a></li>

                        <li><a href="#">{{ __('employers_dashboard') }}</a></li>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 text-center text-lg-start f-size-14 text-gray-500">
                    &copy; {{ config('app.name') }} {{ date('Y') }} | {{ __('all rights reserved') }}
                </div><!-- /.col-lg-6 -->
